...
Storage facts gate every recommendation: a model on an ejected drive is not a
candidate, however good it is. After `aimodels status`, use [ollama.md](ollama.md)
for LLM choice or [asr.md](asr.md) for transcription choice.
