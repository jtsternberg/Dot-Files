...
final class GraveyardTest extends TestCase
{
	...
	public function testTitleizeSummary(): void
	{
		...
		$this->assertSame('/system-watchdog', $this->gy->titleizeSummary(['summary' => '/system-watchdog', 'tab_title' => '.dotfiles', 'cwd' => '/Users/JT/.dotfiles', 'workspace_title' => 'ws']));
		$this->assertSame('/review --full src/', $this->gy->titleizeSummary(['summary' => '/review --full src/', 'tab_title' => 'project', 'cwd' => '/Users/JT/project', 'workspace_title' => 'ws']));
		$this->assertSame('.dotfiles', $this->gy->titleizeSummary(['summary' => '/Users/JT/.dotfiles', 'tab_title' => '.dotfiles', 'cwd' => '/Users/JT/.dotfiles', 'workspace_title' => 'ws']));
